...
// const PATH: &str = "data/data/address_data_part_50.parquet";
...
async fn main() -> Result<(), ()> {
    ...
    let filter = ArrowPredicateFn::new(ProjectionMask::all(), move |record_batch| {
        contains(
            record_batch.column(3),
            &Scalar::new(&LargeStringArray::from(vec![q.clone()])),
        )
    });
